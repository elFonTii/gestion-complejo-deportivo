...
module.exports = class Booking {
    ...
    async isBusy(){
        ...
        const query = `SELECT count(*) as count FROM booking WHERE date_booking = ? AND start_booking = ? AND cancha = ?`;
        const values = [this.date_booking, this.start_booking, this.cancha];
